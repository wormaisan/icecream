...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slides__slider').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1,
  "dots": true,
  "arrows": false
});
var fieldsPhone = document.querySelectorAll('.inputCall');
var inputsForClear = document.querySelectorAll('input, textarea');
window.onload = function () {
  //очищаем все поля
  if (inputsForClear.length > 0) {
    for (var i = 0; i < inputsForClear.length; i++) {
  ...
  for (var _i = 0; _i <= fieldsPhone.length - 1; _i++) {
    new IMask(fieldsPhone[_i], maskOptions);
  }
  //**************************
};
...
var burgerLinks = document.querySelectorAll('.header__burgerMenu a, .header__burgerMenu button');
...
//закрытие модальных окон по кнопке внутри окна
var closeBtnModal = document.querySelectorAll('.closeModal');
if (closeBtnModal.length > 0) {
  for (var _i3 = 0; _i3 < closeBtnModal.length; _i3++) {
    closeBtnModal[_i3].addEventListener('click', function () {
...
var btnBuyNow = document.querySelectorAll('.header__btn');
var modalBuyNow = document.querySelector('.modalBuyNow');
if (btnBuyNow.length > 0) {
  for (var _i4 = 0; _i4 < btnBuyNow.length; _i4++) {
    btnBuyNow[_i4].addEventListener('click', function () {
      if (modalBuyNow !== null) {
        modalBuyNow.parentElement.classList.add('active');
      }
    });
  }
}
...
//модальное окно "How made"
var btnHowMade = document.querySelector('.made__btn');
var modalHowMade = document.querySelector('.modalMade');
if (btnHowMade !== null) {
  btnHowMade.addEventListener('click', function () {
    if (modalHowMade !== null) {
      modalHowMade.parentElement.classList.add('active');
    }
  });
}
//**************************************************************************

//модальное окно "Our Location"
var btnLocation = document.querySelector('.contacts__btn--location');
var modalLocation = document.querySelector('.modalLocation');
if (btnLocation !== null) {
  btnLocation.addEventListener('click', function () {
    if (modalLocation !== null) {
      modalLocation.parentElement.classList.add('active');
    }
  });
}
//**************************************************************************
...
var btnFranchise = document.querySelector('.contacts__btn--franchise');
var modalFranchise = document.querySelector('.modalFranchise');
if (btnFranchise !== null) {
  btnFranchise.addEventListener('click', function () {
    if (modalFranchise !== null) {
      modalFranchise.parentElement.classList.add('active');
    }
  });
}
//**************************************************************************

//модальное окно отдельного продукта
var btnProducts = document.querySelectorAll('.products__cardArrow');
var modalProdCard = document.querySelector('.modalProductCards');
if (btnProducts.length > 0) {
  for (var _i5 = 0; _i5 < btnProducts.length; _i5++) {
    btnProducts[_i5].addEventListener('click', function () {
      if (modalProdCard !== null) {
        var productBodies = document.querySelectorAll('.modalProductCards__card');
        if (productBodies.length > 0) {
          for (var j = 0; j < productBodies.length; j++) {
            productBodies[j].classList.add('blockHide');
          }
        }
        var productBody = document.querySelector('.modalProductCards__card[data-id="' + this.id + '"]');
        if (productBody != null) {
          //устанавливаем цвет фона картинки и элементов как у товара, с которого перешли
          var card = this.parentElement;
          var cardImg = card.querySelector('.products__cardImg');
          var bgcColorImg = window.getComputedStyle(cardImg).getPropertyValue('background');
          var boxShadowImg = window.getComputedStyle(cardImg).getPropertyValue('box-shadow');
          productBody.querySelector('.modalProductCards__cardImg').style.background = bgcColorImg;
          productBody.querySelector('.modalProductCards__cardImg').style.boxShadow = boxShadowImg;
          var bgcColorCard = window.getComputedStyle(card).getPropertyValue('background');
          var cardEnergyItems = productBody.querySelectorAll('.modalProductCards__cardEnergyItem');
          if (cardEnergyItems.length > 0) {
            for (var _j = 0; _j < cardEnergyItems.length; _j++) {
              cardEnergyItems[_j].style.borderColor = bgcColorCard;
              cardEnergyItems[_j].querySelector('.modalProductCards__cardEnergyItemNum').style.background = bgcColorCard;
              cardEnergyItems[_j].querySelector('.modalProductCards__cardEnergyItemNum').style.boxShadow = boxShadowImg;
            }
          }
          //*************************************

          productBody.classList.remove('blockHide');
        }
        modalProdCard.parentElement.classList.add('active');
      }
    });
  }
}
